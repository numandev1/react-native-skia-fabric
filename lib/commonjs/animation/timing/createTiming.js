...
const createTiming = (params, value, callback) => {
  ...
  const animationFunction = (t, state) => {
    ...
    const nextState = (0, _functions.timing)(t, params.duration, params.easing, (_params$loop = params.loop) !== null && _params$loop !== void 0 ? _params$loop : false, (_params$yoyo = params.yoyo) !== null && _params$yoyo !== void 0 ? _params$yoyo : false, state !== null && state !== void 0 ? state : {
      current: params.from,
      finished: false
    });
