...
const useTiming = (toOrParams, config, callback) => {
  ...
  const value = (0, _useValue.useValue)((_resolvedParameters$f = resolvedParameters.from) !== null && _resolvedParameters$f !== void 0 ? _resolvedParameters$f : 0); // Create timing animation - keep a cached version to avoid
