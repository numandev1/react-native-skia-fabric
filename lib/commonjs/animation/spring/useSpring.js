 ...
 * @returns
 */
const useSpring = (toOrParams, config, callback) => (0, _timing.useTiming)(toOrParams, (0, _spring.createSpringEasing)(config !== null && config !== void 0 ? config : _Spring.Spring.Config.Default), callback);
